...
<body>
    <div class="container">
        ...
        <form method="post" action="">
            ...
            <input type="number" name="nota3" id="nota3" placeholder="Digite a nota 3" required><br>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($media >= 7) {
                echo "<p> A média do aluno é: $media. <br><br><p style='color: green;'>O Aluno está APROVADO.</p>";
            } else {
                echo "<p>A média do aluno é: $media. <br><br><p style='color: red;'>O aluno está REPROVADO!</p>";
            }
